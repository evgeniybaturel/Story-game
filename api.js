...
2. Если игрок написал "Подсказка" — дай намёк в тексте
3. Если игрок написал свою версию и угадал — напиши "УГАДАЛ" в clue
4. Будь строгим, не давай разгадку просто так
`;
    }
...
`;
    ...
    if (!apiKey) {
        ...
        document.getElementById('final-steps').textContent = state
